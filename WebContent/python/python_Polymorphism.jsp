...
<h2>Method Overloading not possible in single class</h2>
<pre id="codepre" >
class B10:
...
<h2>Method Overloading not possible in is-a relationship</h2>
<pre id="codepre">
class B10:
	def getName(self,fname):
		print(fname)
...
<h1>In Python other way to achieve method overloading</h1>
<pre id="codepre">
class B10:
...
<h2>Method Overriding possible in single class</h2>
<p>if we are overriding then our class method executed</p>
<p>if we are not overriding then parent class method executed</p>
<pre id="codepre">
class B10:
	def getName(self,fname):
